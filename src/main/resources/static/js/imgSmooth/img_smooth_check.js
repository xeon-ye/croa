...
WIDGETS.imgSmoothCheck = function (options) {
    ...
    //样式加载
    function styleLoad(numCurrentLeft) {
        $(".bar_right").text("");
        $(".bar_left").css({"width":numCurrentLeft,"border-bottom":"1px solid #1991fa","border-top":"1px solid #1991fa","border-left":"1px solid #1991fa","background-color": "#dec3c3"});
    }
