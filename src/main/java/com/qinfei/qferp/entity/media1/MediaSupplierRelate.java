...
/**
 * @CalssName MediaSupplierRelate
 * @Description  媒体板块关系表
 * @Author xuxiong
 * @Date 2019/6/25 0025 18:25
 * @Version 1.0
 */
@Table(name = "t_media_supplier_relate")
@Setter
@Getter
@ToString
public class MediaSupplierRelate implements Serializable {
    ...
    @Transient
    private List<MediaSupplierPrice> mediaSupplierPriceList; //媒体供应商价格
}
