...
/**
 * 表：对接人信息(TCrmCompanyUserHistory)实体类
 *
 * @author jca
 * @since 2020-07-29 17:56:01
 */
@Data
@Table(name = "t_crm_company_user_history")
public class CrmCompanyUserHistory implements Serializable {
    /**
    * 对接人主键
    */
    @Id
