 ...
 */
public class UpdateHiTaskCommand implements Command {
	// 任务ID；
	...
	public UpdateHiTaskCommand(String taskId, String owner, String assignee, String deleteReason) {
		this.taskId = taskId;
		this.owner = owner;
	...
	public Void execute(CommandContext commandContext) {
		...
		if (historicTaskInstance != null) {
			...
			CommandContextUtil.getDbSqlSession().update(historicTaskInstance);
		}
		return null;
	}
}