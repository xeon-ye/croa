...
/**
 * @CalssName BusinessTaskHandler
 * @Description 业务确认
 * @Author xuxiong
 * @Date 2019/9/30 0030 9:40
 * @Version 1.0
 */
public class BusinessTaskHandler implements TaskListener, ICommonTaskHandler {
    @Override
        ...
        if (StringUtils.isEmpty(nextUser) || StringUtils.isEmpty(nextUserName) || StringUtils.isEmpty(nextUserDept)) {
            switch (state){
                ...
                case IConst.STATE_YW:
                    ...
                    if(userId == null){
                        throw new QinFeiException(1001, "业务人员不存在！");
                    }
