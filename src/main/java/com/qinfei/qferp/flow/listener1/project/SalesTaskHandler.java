 ...
 * 销售
 */
public class SalesTaskHandler implements ICommonTaskHandler, TaskListener {
    @Override
        ...
        if (StringUtils.isEmpty(nextUser) || StringUtils.isEmpty(nextUserName) || StringUtils.isEmpty(nextUserDept)){
            ...
            switch (state){
                ...
                case IConst.STATE_REJECT:
                    ...
                    break;
                case IConst.STATE_SALES:
                    datas = getApproveUserId(delegateTask, IConst.ROLE_TYPE_MJ, IConst.ROLE_CODE_ZZ, company, true);
                    nextUser = datas[0];
