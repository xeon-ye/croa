package com.qinfei.qferp.flow.listener1.onbusiness;
...
/**
 * @CalssName MajordomoTaskHandler
 * @Description 总监审核
 * @Author xuxiong
 * @Date 2019/9/27 0027 15:44
 * @Version 1.0
 */
public class MajordomoTaskHandler implements TaskListener, ICommonTaskHandler {
    @Override
    ...
    public void updateProcessData(DelegateTask delegateTask) {
        ...
        map.put("messageTypeName","出差");//消息子类类型名称
        map.put("type",10);//出差
        ...
        //如果当前节点审核人为空，则跳转到总经理审核
        if(delegateTask.getAssignee() == null){
            RuntimeService runtimeService = SpringUtils.getBean(RuntimeService.class);
            runtimeService.createChangeActivityStateBuilder()
                    .processInstanceId(delegateTask.getProcessInstanceId())
                    .processVariables(delegateTask.getVariables())
                    .moveActivityIdTo(delegateTask.getTaskDefinitionKey(), "financeApprove")
                    .changeState();
            return;
        }
