...
/**
 * @CalssName GeneralManagerReviewTaskHandler
 * @Description 总经理复审
 * @Author xuxiong
 * @Date 2019/9/27 0027 16:09
 * @Version 1.0
 */
public class GeneralManagerReviewTaskHandler implements TaskListener, ICommonTaskHandler {
    @Override
